...
INTERVIEW_STAGES = [
    # 1. 자기소개(템플릿)
    {
        ...
        "display_name": "기본 질문",
        "type": "template",
        "template": "반갑습니다.{candidate_name} 지원자님, 자기소개 부탁드립니다.",
    ...
    # 2. 지원동기+직무변환(템플릿)
    {
        ...
        "type": "template",
        "template": "{candidate_name} 지원자님,'{target_role}'직무에 지원하게 된 동기는 무엇입니까? 또한 {major}을 전공하셨는데 어떤 계기로 {target_role}에 관심을 가지게 되셨나요?",
        "order": 2
    },
