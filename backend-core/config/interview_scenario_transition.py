...
INTERVIEW_STAGES = [
    ...
    # 14. 성장의지 꼬리질문 (AI 생성 - 답변 기반)
    {
        ...
        "type": "followup",
        "parent": "growth",
        "guide": "지원자의 이전 답변에서 언급된 성장 태도를 '~라고 말씀하셨는데'와 같이 인용하며 시작하십시오. 그 후, 스스로 설정한 목표가 뜻대로 되지 않거나 성장이 정체되었다고 느낄 때 본인만의 평정심을 유지하며 꾸준히 나아가는 방법이나 마음가짐에 대해 1개의 단일 질문을 던지십시오. 동료나 조직 상황은 언급하지 말고 오직 지원자 개인의 내면적 태도에만 집중하십시오. 모든 질문은 반드시 '~주세요.'로 끝내고 물음표를 사용하지 마십시오.",
        "order": 14
    },
