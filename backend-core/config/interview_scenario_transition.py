...
INTERVIEW_STAGES = [
    ...
    # 11. 책임감 및 가치관 평가 (AI 생성 - 인재상 기반)
    {
        ...
        "type": "ai",
        "category": "narrative",
        "guide": "이력서나 자기소개서에서 지원자의 가치관이나 직업 윤리가 드러난 부분을 인용하며 (~라고 작성하셨는데,)로 질문을 시작하십시오. 그 내용을 회사의 인재상인 '{company_ideal}'과 연결하여, 비전공자로서 새로운 직군(IT)에 임할 때 어떤 기준과 책임감을 가지고 업무를 수행할 것인지 질문하십시오. 모든 질문은 반드시 '~주세요.'로 끝내고 물음표를 절대 사용하지 마십시오.",
        "order": 11
    },
