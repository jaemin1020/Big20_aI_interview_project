...
INTERVIEW_STAGES = [
    ...
    # 11. 책임감 및 가치관 평가 (AI 생성 - 인재상 기반)
    {
        ...
        "type": "ai",
        "category": "narrative",
        "guide": "회사의 인재상인 '{company_ideal}'의 가치와 '책임감'을 연결하는 질문을 생성하십시오. 특히 기술 확산에 따른 윤리적 문제나 사회적 가치를 우선시하는 태도를 확인할 수 있는 상황 중심의 질문이어야 합니다. 모든 질문은 반드시 '~주세요.'로 끝내고 물음표를 절대 사용하지 마십시오.",
        "order": 11
    },
    ...
    # 13. 성장의지 및 창의성 평가 (AI 생성 - 인재상 기반)
    {
        ...
        "type": "ai",
        "category": "narrative",
        "guide": "회사의 인재상인 '{company_ideal}'에서 '새로운 관점'과 '세상의 풍요로움'이라는 키워드를 추출하여 질문을 생성하십시오. 단순히 공부를 열심히 한 경험이 아니라, 새로운 사용자 경험으로 치환하거나 타 분야와의 융합을 추구했던 의지를 확인하십시오. 모든 질문은 반드시 '~주세요.'로 끝내고 물음표를 절대 사용하지 마십시오.",
        "order": 13
    },
