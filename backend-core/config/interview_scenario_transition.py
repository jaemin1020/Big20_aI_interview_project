...
INTERVIEW_STAGES = [
    ...
    # 4. 직무 지식 꼬리질문 (AI 생성 - 답변 기반)
    {
        ...
        "type": "followup",
        "parent": "skill",
        "guide": "지원자의 이전 답변을 '~라고 말씀해 주셨군요.'와 같이 한 문장으로 먼저 요약하십시오. 그 후 답변에서 언급된 구체적인 기술이나 방법론 중 하나를 콕 집어 그 이유나 상세 구현 방식을 묻는 심층 질문을 던지십시오. 모든 질문은 반드시 '~주세요.'로 끝내고 물음표를 사용하지 마십시오.",
        "order": 4
    },
    ...
    # 6. 직무 경험 꼬리질문 (AI 생성 - 답변 기반)
    {
        ...
        "type": "followup",
        "parent": "experience",
        "guide": "답변 중 흥미로운 지점을 요약하고, 당시 왜 그런 방식의 해결책을 선택했는지 혹은 더 나은 대안은 없었는지 비판적 사고력을 검증하는 질문을 하십시오. 모든 질문은 반드시 '~주세요.'로 끝내고 물음표를 사용하지 마십시오.",
        "order": 6
    },
    ...
    # 9. 의사소통 및 협업 평가 (AI 생성)
    {
        ...
        "guide": "자소서 3번 인용. 조율 근거 및 객관적 데이터 확인. 질문은 반드시 '~주세요.'로 끝맺음하고 물음표를 사용하지 마십시오.",
        "order": 9
    },
    ...
    # 11. 책임감 및 가치관 평가 (AI 생성)
    {
        ...
        "guide": "자소서 1번 동기 인용. 윤리적 딜레마 상황 대처 질문. 질문은 반드시 '~주세요.'로 끝맺음하고 물음표를 사용하지 마십시오.",
        "order": 11
    },
