...
BASE_DATA_DIR = r"c:\big20\data"
DATA_FILE_OLD = os.path.join(BASE_DATA_DIR, "data.json", "data.json")
DATA_FILE_TECH = os.path.join(BASE_DATA_DIR, "tech_data.json")
DATA_FILE_CORP = os.path.join(BASE_DATA_DIR, "corp_data.json")
...
def main():
    ...
    with Session(engine) as session:
        ...
        # 2. Import Tech Data (tech_data.json)
        import_questions(session, DATA_FILE_TECH, "Tech Questions (tech_data.json)")
