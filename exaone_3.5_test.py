...
# 기존에 설치된 Ollama의 'exaone3.5' 모델을 사용합니다.  exaone3.5:latest (4.8GB)
# ==================================================================================
...
class ExaoneTestModule:
    def __init__(self, model_name: str = "exaone3.5:latest"):
        ...
        Args:
            model_name (str): Ollama에 등록된 모델명 (default: "exaone3.5:latest")
        """
        ...
        print(f"[ExaoneTestModule] 초기화 완료: Ollama 모델 '{self.model_name}' 사용")
